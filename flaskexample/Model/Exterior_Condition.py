...
def main(total, cmdargs):
	...
	recommend = recommend[recommend["R_EXT_CND_G"]!=1]
	recommend = recommend[recommend["R_EXT_CND_E"]!=1]

	BuildStylFeat = ['R_EXT_CND_A','R_EXT_CND_E', 'R_EXT_CND_F', 'R_EXT_CND_G', 'R_EXT_CND_P']
	recommend[BuildStylFeat] = 0;
	recommend["R_EXT_CND_G"] = 1;
	...
	recommend["Expected_RenoCost"] = recommend["NUM_FLOORS"]*1000; 
	...
	recommend.to_csv("Ext_Cond.csv",index=False); 
	#return(recommend);
