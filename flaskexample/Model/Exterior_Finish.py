...
def main(total, cmdargs):
	...
	recommend = recommend[recommend["R_EXT_FIN_B"]!=1]
	...
	recommend["Expected_RenoCost"] = recommend["NUM_FLOORS"]*5000; 
	...
	recommend.to_csv("Ext_Fin.csv",index=False); 
	#return(recommend);
