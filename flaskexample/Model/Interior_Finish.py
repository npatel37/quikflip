...
def main(total, cmdargs):
	...
	recommend["Expected_RenoCost"] = recommend["NUM_FLOORS"]*7000; 
	...
	recommend.to_csv("Int_Fin.csv",index=False); 
	#return(recommend);
